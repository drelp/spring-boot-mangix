...
public class CodeGenerator2 {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/mangix"+ "?serverTimezone=UTC";
    ...
    public static void genModelAndMapper(String tableName, String modelName) {
        ...
        javaModelGeneratorConfiguration.setTargetPackage(MODEL_PACKAGE + ".second");
        context.setJavaModelGeneratorConfiguration(javaModelGeneratorConfiguration);

        SqlMapGeneratorConfiguration sqlMapGeneratorConfiguration = new SqlMapGeneratorConfiguration();
        sqlMapGeneratorConfiguration.setTargetProject(PROJECT_PATH + RESOURCES_PATH);
        sqlMapGeneratorConfiguration.setTargetPackage("mapper.second");
        context.setSqlMapGeneratorConfiguration(sqlMapGeneratorConfiguration);

        JavaClientGeneratorConfiguration javaClientGeneratorConfiguration = new JavaClientGeneratorConfiguration();
        javaClientGeneratorConfiguration.setTargetProject(PROJECT_PATH + JAVA_PATH);
        javaClientGeneratorConfiguration.setTargetPackage(MAPPER_PACKAGE + ".second");
    ...
    public static void genService(String tableName, String modelName) {
        try {
            ...
            cfg.getTemplate("service-impl2.ftl").process(data,
